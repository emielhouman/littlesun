...
if (isset($_POST['delete'])) {
    $member = Member::getMemberWithId($_POST['id']);
    $_SESSION['deleted_member'] = $member;
...
if (isset($_POST['undo_delete'])) {
    if (isset($_SESSION['deleted_member'])) {
        $deletedMember = $_SESSION['deleted_member'];
        $member = new Member();
        $member->setFirstname($deletedMember['firstname']);
        $member->setLastname($deletedMember['lastname']);
        $member->setEmail($deletedMember['email']);
        $member->setPassword($deletedMember['password']);
        $member->setRoleId($deletedMember['role_id']);
        $member->setLocationId($deletedMember['location_id']);
        $member->save();

        unset($_SESSION['deleted_member']);
        $_SESSION['success_message'] = "Member restored successfully!";
