        ...
        <div class="ml-72 px-14 py-10 flex-1">
            ...
            <form class="w-full grid grid-cols-2 gap-x-14 gap-y-6 px-12" action="" method="post">
                ...
                <div class="pt-8 col-span-2">
                    <input class="w-full h-12 font-bold uppercase justify-self-center cursor-pointer rounded bg-yellow-400 border-yellow-400 border-2" type="submit" value="Add member">
                </div>
            </form>
        </div>
    </div>
