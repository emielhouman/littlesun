...
$tasksPage = ($roleId == 1) ? "tasks.php" : "asigntask.php";
$userPage = ($roleId == 2) ? "members.php" : "managers.php";
...
?><nav class="flex flex-col bg-black text-gray-50 h-screen w-72 pt-8 pb-6 pl-4 pr-6">
    ...
    <ul class="navigation__menu">
        ...
        <li class="flex gap-4 items-center rounded p-3.5 my-2 hover:bg-gray-500 hover:bg-opacity-25">
            ...
            <a class="block font-semibold text-lg tracking-wide" href="<?php echo $tasksPage; ?>">Tasks</a>
            </li>
