...
if (isset($_GET['id']) && isset($_GET['mode'])) {
    ...
    usort($managers, "sortManagersWithLocationId");
    ...
    if ($_GET['mode'] === "edit" && !empty($_POST)) {
        ...
        header("Location: location.php?id=" . $_GET['id'] . "&mode=read");
        exit;
...
function sortManagersWithLocationId($a, $b)
{
    ...
    <div class="flex w-screen relative">
        ...
        <div id="popup-scrn" class="w-screen h-screen items-center justify-center absolute z-10 top-0 left-0 bg-black/50" style="display: none;">
            <div class="w-2/5 p-12 bg-white rounded-lg relative">
                <h3 class="font-semibold text-2xl pb-8">Select a HUB Manager:</h3>
        ...
        <div class="ml-72 px-14 py-10 flex-1">
            <div class="flex justify-between mb-12">
                <h2 class="font-extrabold text-4xl">HUB Location: <span class="font-normal"><?php echo $location['name'] ?></span></h2>
            ...
            <form class="w-full grid grid-cols-2 gap-x-14 gap-y-6 p-16 border-2 rounded-lg shadow-md" action="" method="post">
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <button class="w-full h-12 flex items-center justify-between px-2.5 rounded border-2 border-gray-300 <?php echo ($_GET['mode'] === "edit" ? "bg-white" : "bg-gray-100") ?> manager__select" type="button" <?php echo ($_GET['mode'] === "edit" ? "" : "disabled") ?>>
